...
from shared.entities.email_verification import ABCEmailVerificationRepository
from shared.entities.refresh_token import ABCRefreshTokenRepository
...
def get_auth_service(
    ...
    refresh_token_repo: Annotated[
        ABCRefreshTokenRepository, Depends(get_refresh_token_repo)
    ],
    email_verification_repo: Annotated[
        ABCEmailVerificationRepository, Depends(get_email_verification_repo)
    ],
